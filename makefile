...
CFILES = test_parse_cfg.c test_statistics.c test_trace.c test_memory.c
HFILES = test_parse_cfg.h test_statistics.h test_trace.h test_memory.h

all : proj main

main : main.c test_memory.o ../memory.o test_trace.o ../trace.o test_statistics.o ../statistics.o test_parse_cfg.o ../parse_config.o ../common.o
	$(CC) $^ -o main $(CFLAGS)
