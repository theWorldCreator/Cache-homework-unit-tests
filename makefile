...
main : main.c test_cache.o ../cache.o ../direct_cache.o ../random.o ../full_cache.o test_memory.o ../memory.o test_trace.o ../trace.o test_statistics.o ../statistics.o test_parse_cfg.o ../parse_config.o ../common.o
	$(CC) $^ -o main $(CFLAGS)
